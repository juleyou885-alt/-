...
local Window = Rayfield:CreateWindow({
   Name = "hack script",
   LoadingTitle = "Lod...",
   LoadingSubtitle = "by iev1234_Noob1",
   ConfigurationSaving = {
      Enabled = false,
   ...
   KeySettings = {
      Title = "Key",
      Subtitle = "KYC's cute",
      Note = "https://pastebin.com/raw/sJ3dAZ7W",
      ...
      Key = {"https://pastebin.com/raw/sJ3dAZ7W"} -- List of keys that will be accepted by the system, can be RAW file links (pastebin, github etc) or simple strings ("hello","key22")
   }
})
...
local MainTab = Window:CreateTab("👍Esp script👍", nil) -- Title, Image
local MainSection = MainTab:CreateSection("Main")

local Button = MainTab:CreateButton({
   Name = "Kwon Yoon-sung was ugly(esp)",
   Callback = function()
...
local Button = MainTab:CreateButton({
   Name = "Kwon Yoon-sung was ugly2(prison life)",
   Callback = function()
...
local MainTab = Window:CreateTab("Main Tab2", nil) -- Title, Image
local MainSection = MainTab:CreateSection("Main")
...
local Button = MainTab:CreateButton({
   Name = "(prison life hack2)",
   Callback = function()
       loadstring(game:HttpGet("https://raw.githubusercontent.com/kimbenner/script/main/alphascript"))()
   end,
})

local MainTab = Window:CreateTab("👑Star's Game👑", nil) -- Title, Image
local MainSection = MainTab:CreateSection("Main")

local Button = MainTab:CreateButton({
   Name = "(Star game Script)",
   Callback = function()
...
local MainTab = Window:CreateTab("👑esp2👑", nil) -- Title, Image
local MainSection = MainTab:CreateSection("Main")

local Button = MainTab:CreateButton({
   Name = "(esp2)",
   Callback = function()
       loadstring(game:HttpGet(('https://pastefy.app/hTu2V7a0/raw'),true))()
   end,
})

local MainTab = Window:CreateTab("👑비었음👑", nil) -- Title, Image
local MainSection = MainTab:CreateSection("Main")
...
local MainTab = Window:CreateTab("👑레벨 테스트👑", nil) -- Title, Image
local MainSection = MainTab:CreateSection("Main")

local Button = MainTab:CreateButton({
   Name = "(레벨 테스트(printidentity() )",
   Callback = function()
        printidentity()
   end,
})
...
local Button = MainTab:CreateButton({
   Name = "( print(욕으로 콘솔에 나오게 하는 버전. F9) )",
   Callback = function()
        print("야이 씹새끼야 느그 애미 좆도 뒤졌나 씹새끼야ㅋㅋㄹㅃㅃ 응 느금마 어쩔")
   end,
})

local Button = MainTab:CreateButton({
   Name = "킹레거시 (King Legacy)",
   Callback = function()
...
local Button = MainTab:CreateButton({
   Name = "IWV님의 부대 테러 스크립트(비번:12345678)",
   Callback = function()
        loadstring(game:HttpGet('https://raw.githubusercontent.com/pudong8452/awrwrqrq/main/qwetuio'))()
   end,
})
...
local Button = MainTab:CreateButton({
   Name = "스파이더맨",
   Callback = function()
         loadstring(game:HttpGet('https://pastebin.com/raw/0MUapE0G'))() 
   end,
})

local Button = MainTab:CreateButton({
   Name = "get boxer glove(slap battles)",
   Callback = function()
...
local Button = MainTab:CreateButton({
   Name = "get boxer slap farm(slap battles)",
   Callback = function()
...
local Button = MainTab:CreateButton({
   Name = "사람 끌리기",
   Callback = function()
         loadstring(game:HttpGet("https://cdn.wearedevs.net/scripts/Magnetize%20To%20Player.txt"))()
   end,
})
...
local Button = MainTab:CreateButton({
   Name = "닌자 겜패 없이 보유",
   Callback = function()
         loadstring(game:HttpGet("https://pastebin.com/raw/bgDCTeBG"))()
   end,
})
...
local Button = MainTab:CreateButton({
   Name = "닌자 무기",
   Callback = function()
         loadstring(game:HttpGet("https://pastebin.com/raw/5i4SmqZP"))()
   end,
})

local Button = MainTab:CreateButton({
   Name = "타워 오프 헬 모든 아이템 획득",
   Callback = function()
...
local Button = MainTab:CreateButton({
   Name = "트때따 사람 날리기(갓핸드로)",
   Callback = function()
         loadstring(game:HttpGet("https://pastebin.com/raw/cA6Pjybz"))()
   end,
})
...
local Button = MainTab:CreateButton({
   Name = "트때따 갓핸드 얻기",
   Callback = function()
         loadstring(game:HttpGet("https://pastebin.com/raw/rJ3xU771"))()
   end,
})
...
local Button = MainTab:CreateButton({
   Name = "Aim Bot",
   Callback = function()
         loadstring(game:HttpGet("https://pastebin.com/raw/2HA7D4k6"))()
   end,
})
...
local Button = MainTab:CreateButton({
   Name = "쓰나미 게임 핵",
   Callback = function()
         loadstring(game:HttpGet("https://pastebin.com/raw/gsDWxRGb"))()
   end,
})